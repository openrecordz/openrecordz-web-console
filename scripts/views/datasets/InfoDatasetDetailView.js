...
//	'views/datasets/ListDataDetailView',
	'text!templates/datasets/infoDatasetDetailTemplate.html',
...
//		Utils, 
		moment, bootbox,
//		ListDataDetailView,
	infoDatasetDetailTemplate){ 
	
	var InfoDatasetDetailView = BaseView.extend({
		template: _.template(infoDatasetDetailTemplate),
//		datasetId: null,	
		datasetMeta:null,
		data:null,
		header:null,
...
//			"click #btnDataSearch" : "search",
		...
		initialize: function() {
			console.log('InfoDatasetDetailView.initialize');
//			_.bindAll(this);
...
//				pippo3=this.header;
		...
		render: function(){
			console.log('InfoDatasetDetailView.render');
//			console.log('===========================================');
